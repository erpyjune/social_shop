...
include "../lib/zeppelin.class.php";
...
$t_sql = "select keyword1, url from SOCIAL_SHOP_CRAWL_T where cp='zeppelin'";
$s_db->connect();
...
while ($row = $result->fetch_assoc()) {
	...
	for (;;) {
		...
		$search_list = $pa->getListCount($body, $cp->list_s, 1, $cp->list_e, 2);
